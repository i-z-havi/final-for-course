...
export default function usePolicy() {
  ...
  const handleGetPolicy = useCallback(
    async (id) => {
      try {
  ...
  const handleCreatePolicy = useCallback(
    async (policy) => {
      try {
        ...
        snack(
          "success",
          "Petition created successfully! Please wait for Admin approval."
        );
  ...
  const handleUpdatePolicy = useCallback(
    async (id, updatedPolicy) => {
      try {
        ...
        snack(
          "success",
          "Policy has been successfully updated! Please wait for Admin approval."
        );
      } catch (error) {
        snack("error", error);
      }
  ...
  const handleSignPolicy = useCallback(
    async (policy, signed) => {
      try {
  ...
  const handleAllowPolicy = useCallback(
    async (policy) => {
      try {
