...
export default function PolicyPresenter(policies) {
  ...
  return (
    <>
      {policies.policies.length !== 0 ? <Grid
        container
        spacing={0}
        direction="column"
        alignItems="center"
              ...
              >
                ...
                <Stack direction='row'
                  ...
                  <Button onClick={() => handlePolicyClick(policy.id)}
                    sx={{ width: (user && user.id === policy.creatorId) ? "33%" : "100%" }}>
                    To Petition
                  </Button>
      ...
      >
        <br />
        <img src='../assets/images/128px-Icon-round-Question_mark.svg.png' alt="noItemsFound" />
        <br />
